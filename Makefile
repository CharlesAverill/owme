...
DOCS_PATH=docs/
DOCS_NAME=owm
DOCS_DESCR=A Window Manager written in the OCaml Graphics library
...
<meta content="https://github.com/CharlesAverill/owm" property="og:url" />
endef
...
docs: cleandocs build
	...
	mv $(DOCS_PATH)owm/owm.html $(DOCS_PATH)index.html
	mv $(DOCS_PATH)owm $(DOCS_PATH)module
